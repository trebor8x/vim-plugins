...
hi Folded       guifg=#a0a8b0 guibg=#202020 gui=none ctermbg=237 ctermfg=255
...
hi Function   guifg=#ffffff gui=bold ctermfg=167
hi Class      guifg=#ffffff gui=bold ctermfg=11
...
" C/CPP-specific colors
hi cppAccessLabels ctermbg=177 ctermfg=0
